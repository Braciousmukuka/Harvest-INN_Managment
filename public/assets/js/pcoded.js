...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .landing-logo')) {
      document.querySelector('.navbar-brand .landing-logo').setAttribute('src', 'assets/images/logo-white.svg');
    }
    ...
    if (document.querySelector('.navbar-brand .landing-logo')) {
      document.querySelector('.navbar-brand .landing-logo').setAttribute('src', 'assets/images/logo-dark.svg');
    }
    if (document.querySelector('.auth-main .brand-logo')) {
