                    ...
                    <form action="{{ route('sales.store') }}" method="POST" id="saleForm">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('quantity_sold') is-invalid @enderror" 
                                           name="quantity_sold" id="quantity_sold" value="{{ old('quantity_sold', 1) }}" 
                                           min="1" step="0.01" required>
                                    <span class="input-group-text" id="quantity_unit_display">units</span>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('customer_address') is-invalid @enderror" 
                                          name="customer_address" id="customer_address" rows="2">{{ old('customer_address') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control @error('sale_date') is-invalid @enderror" 
                                       name="sale_date" id="sale_date" value="{{ old('sale_date', date('Y-m-d')) }}" required>
                                @error('sale_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('payment_reference') is-invalid @enderror" 
                                       name="payment_reference" id="payment_reference" value="{{ old('payment_reference') }}"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i data-feather="save"></i>&nbsp;Create Sale
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="summary-item mb-3">
                        <div class="d-flex justify-content-between">
                            <span>Quantity:</span>
                            <span id="summary_quantity">-</span>
                        </div>
                    </div>
                    <div class="summary-item mb-3">
                        <div class="d-flex justify-content-between">
                            <span>Unit Price:</span>
                            <span id="summary_unit_price">ZMW 0.00</span>
                        </div>
                    </div>
                    <div class="summary-item mb-3">
                        <div class="d-flex justify-content-between">
                            <span>Subtotal:</span>
                            <span id="summary_subtotal">ZMW 0.00</span>
                        </div>
                    </div>
                    <div class="summary-item mb-3">
                        <div class="d-flex justify-content-between">
                            <span>Discount:</span>
                            <span id="summary_discount" class="text-success">ZMW 0.00</span>
                        </div>
                    </div>
                    <hr>
                    <div class="summary-item">
                        <div class="d-flex justify-content-between">
                            ...
                            <strong id="summary_total" class="text-primary">ZMW 0.00</strong>
                        </div>
                    </div>
                </div>
            </div>
