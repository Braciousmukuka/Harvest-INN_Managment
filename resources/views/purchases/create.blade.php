                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="supplier_address" name="supplier_address" rows="2">{{ old('supplier_address') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="item_description" name="item_description" rows="3">{{ old('item_description') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="quantity" name="quantity" value="{{ old('quantity') }}" step="0.01" min="0" required>
                            @error('quantity')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="quantity_unit" name="quantity_unit" required>
                                ...
                                <option value="liters" {{ old('quantity_unit') == 'liters' ? 'selected' : '' }}>Liters</option>
                                <option value="bags" {{ old('quantity_unit') == 'bags' ? 'selected' : '' }}>Bags</option>
                                <option value="boxes" {{ old('quantity_unit') == 'boxes' ? 'selected' : '' }}>Boxes</option>
                                <option value="tons" {{ old('quantity_unit') == 'tons' ? 'selected' : '' }}>Tons</option>
                                <option value="meters" {{ old('quantity_unit') == 'meters' ? 'selected' : '' }}>Meters</option>
                            </select>
                            @error('quantity_unit')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="unit_price" name="unit_price" value="{{ old('unit_price') }}" step="0.01" min="0" required>
                            @error('unit_price')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="total_amount" name="total_amount" value="{{ old('total_amount') }}" step="0.01" min="0" required readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="storage_location" name="storage_location" value="{{ old('storage_location') }}" placeholder="e.g., Warehouse A, Section 2">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Additional notes about this purchase">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
